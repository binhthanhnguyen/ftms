...
require Rails.root.join("lib", "rails_admin", "remove_subjects_from_course.rb")
...
RailsAdmin::Config::Actions.register(RailsAdmin::Config::Actions::RemoveSubjectsFromCourse)
